...
model_full = RandomForestClassifier(random_state=42, **best_params)
...
print("Running LOFO analysis with RandomizedSearchCV best params...")
...
# Sort and prepare display label
...
plt.title('Leave-One-Feature-Out Impact on Random Forest (F1-score)')
